...
import dev.mrwick.redline.analytics.SpeedTrack
import dev.mrwick.redline.analytics.SpeedTrackColors
...
import dev.mrwick.redline.export.GpxExporter
import dev.mrwick.redline.export.ShareCardRenderer
import dev.mrwick.redline.export.TripShareText
import dev.mrwick.redline.ui.components.SkeletonBlock
import dev.mrwick.redline.ui.components.SkeletonCard
import dev.mrwick.redline.ui.components.SkeletonLine
        ...
        if (samples.size >= 2) {
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(20.dp)) {
                    ...
                    dev.mrwick.redline.ui.components.TraceChart(
...
private fun RideTrackCard(
    ...
    samples: List<dev.mrwick.redline.data.RideSampleEntity>,
) {
...
@Composable
private fun SpeedDistributionCard(samples: List<dev.mrwick.redline.data.RideSampleEntity>) {
...
@Composable
private fun FuelEconomyTrendCard(samples: List<dev.mrwick.redline.data.RideSampleEntity>) {
...
@Composable
private fun FuelLevelCard(samples: List<dev.mrwick.redline.data.RideSampleEntity>) {
