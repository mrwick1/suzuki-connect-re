 ...
 * intentional *duplicates* of the corresponding [dev.mrwick.redline.ui.theme.GixxerTokens]
...
object SpeedTrackColors {
    ...
    /**
     * Cool zone color — mirrors [dev.mrwick.redline.ui.theme.GixxerTokens.zoneCool]
     * (`Color(0xFF10D9C4)`). ARGB = 0xFF10D9C4.
     */
    const val COLOR_COOL: Int = 0xFF10D9C4.toInt()

    /**
     * Mid zone color — mirrors [dev.mrwick.redline.ui.theme.GixxerTokens.zoneMid]
     * (`Color(0xFFF5A524)`). ARGB = 0xFFF5A524.
     */
    const val COLOR_MID: Int = 0xFFF5A524.toInt()

    /**
     * Hot zone color — mirrors [dev.mrwick.redline.ui.theme.GixxerTokens.zoneHot]
