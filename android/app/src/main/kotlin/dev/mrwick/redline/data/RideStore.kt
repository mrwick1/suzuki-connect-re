...
class RideStore(private val dao: RideDao) {
     ...
     *
     * Used by the "Reset all data" action in [dev.mrwick.redline.ui.about.AboutScreen].
     * Does NOT touch the manual fuel-fill log — that lives in a separate table
     * and is wiped by [dev.mrwick.redline.data.FuelFillDao] separately.
     */
     ...
     *
     * Used by [dev.mrwick.redline.ui.routes.RouteRepeatViewModel] to build
